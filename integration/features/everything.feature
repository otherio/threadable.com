...
Given that I am "Jared"
       ...
       Then a task called "buy tons of wood" should be created
...
Given that I am "Jared"
      ...
      When I click on "Add doer"
       ...
       Then an email should be sent to "slim@gmail.com" with the comment "We need lots of wood to build this duck. lets get some. How about you, Slim?"
...
Given that I am "Ian"
       And I go to the project page for the project "build a huge wooden duck"
