!function(){
  ...
  JSReporter.prototype.reportRunnerStarting = noop;

  JSReporter.prototype.reportSpecStarting = function(spec) {
    // Start timing this spec
    spec.startedAt = new Date();
  };

  JSReporter.prototype.reportSpecResults = function(spec) {
  ...
  JSReporter.prototype.reportSuiteResults = noop;

  JSReporter.prototype.reportRunnerResults = function(runner) {
    var
      i, suite,
