class Covered::Project::Messages
  ...
  def message_for message_record
    conversation = message_record.conversation.task? ?
      Covered::Project::Task.new(project, message_record.conversation) :
      Covered::Project::Conversation.new(project, message_record.conversation)
    Covered::Project::Conversation::Message.new(conversation, message_record)
  end
