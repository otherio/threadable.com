...
ActiveRecord::Schema.define(version: 20140315234434) do
  ...
  create_table "attachments_incoming_integration_hooks", force: true do |t|
  ...
  add_index "conversations", ["external_id"], name: "index_conversations_on_external_id", using: :btree
  ...
  add_index "external_authorizations", ["unique_id", "provider"], name: "index_external_authorizations_on_unique_id_and_provider", using: :btree
  ...
  create_table "incoming_integration_hooks", force: true do |t|
    t.text     "params",                                   null: false
