...
describe ProjectsController do
  ...
  describe "GET user_list" do
    ...
    before do
      project.members << [user_alice, user_bob, user]
    end

    it "returns a list of users" do
      xhr :get, :user_list, {:project_id => project.to_param}
      response.should be_success
      result = JSON.parse response.body
      result.should =~ [
        { 'name' => 'Alice', 'email' => 'alice@example.com', 'id' => user_alice.id },
        { 'name' => 'Bob', 'email' => 'bob@example.com', 'id' => user_bob.id },
