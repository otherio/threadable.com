...
describe ConversationsController do
  ...
  describe "GET show" do
    it "assigns the requested conversation as @conversation" do
      conversation = project.conversations.create! valid_attributes
      get :show, valid_params.merge(:id => conversation.to_param), valid_session
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved conversation as @conversation" do
        ...
        post :create, valid_params.merge(:conversation => { "subject" => "invalid value" }), valid_session
  ...
  describe "PUT mute" do
    ...
    #     put :update, valid_params.merge(:id => conversation.to_param, :conversation => { "subject" => "MyString" }), valid_session
    #   end

    #   it "assigns the requested conversation as @conversation" do
    #     conversation = project.conversations.create! valid_attributes
    #     put :update, valid_params.merge(:id => conversation.to_param, :conversation => valid_attributes), valid_session
    #     assigns(:conversation).should eq(conversation)
    #   end
    ...
    #     # Trigger the behavior that occurs when invalid params are submitted
    #     Conversation.any_instance.stub(:save).and_return(false)
    #     put :update, valid_params.merge(:id => conversation.to_param, :conversation => { "subject" => "invalid value" }), valid_session
    #     assigns(:conversation).should eq(conversation)
    #   end
