  ...
  describe 'validating Mail::Message' do
    ...
    context 'when the smtp envelope from is bullshit' do
      ...
      it 'should not send the email' do
        ...
        expect{ send! }.to raise_error Covered::Emails::InvalidEmail, 'invalid envelope from address: "jared <jared@other.io"'
      end
    end
    ...
    context 'when the smtp envelope to is bullshit' do
      ...
      it 'should not send the email' do
        expect(email).to_not receive(:deliver)
        expect{ send! }.to raise_error Covered::Emails::InvalidEmail, 'invalid envelope to address: "jared <jared@other.io>"'
      end
    end
    ...
    context 'when the from is bullshit' do
      ...
      it 'should not send the email' do
        expect(email).to_not receive(:deliver)
        expect{ send! }.to raise_error Covered::Emails::InvalidEmail, 'invalid from address: "jared <jared@other.io"'
      end
    end
    ...
    context 'when the to is bullshit' do
      ...
      it 'should not send the email' do
        expect(email).to_not receive(:deliver)
        expect{ send! }.to raise_error Covered::Emails::InvalidEmail, 'invalid to address: "jared <jared@other.io"'
      end
    end
    ...
    context 'when the subject is blank' do
      ...
      it 'should not send the email' do
        expect(email).to_not receive(:deliver)
        expect{ send! }.to raise_error Covered::Emails::InvalidEmail, 'invalid subject: is blank'
      end
    end
