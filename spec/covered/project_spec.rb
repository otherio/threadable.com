...
describe Covered::Project do
  ...
  it "should require a uniq name" do
    project = Covered::Project.new(name: 'build a fire proof house')
    project.save.should be_true
  ...
  context "when not given a slug" do
    it "should be created from the name if blank" do
      project = Covered::Project.create(name: 'Fall down a hole')
  ...
  describe "#short_name=" do
    ...
    context "when the name is 'Langworth, Barton and Strosin ™'" do
      let(:project){ Covered::Project.create(name: name, short_name: short_name) }
  ...
  describe "#email_address" do
    it "should return a email address" do
      project = Covered::Project.create(name: 'Bob', short_name: 'hole-faller')
  ...
  describe "#slug" do
    it "should be generated from the short name" do
      project = Covered::Project.create(name: 'Fly to the moon', short_name: 'Moon Mission')
