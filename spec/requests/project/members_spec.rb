...
describe "project members" do
  ...
  context "adding an existing user to the project" do
    ...
    def post!
      ...
      assert_background_job_enqueued SendEmailWorker, args: [
        covered.env, "join_notice", project.id, user.id, member_params[:message]
      ]
    ...
    context 'by id' do
      ...
      it 'adds the existing user to the project' do
        post!
      end
    end
  ...
  context "adding a new user to the project" do
    ...
    def post!
      ...
      assert_background_job_enqueued SendEmailWorker, args: [
        covered.env, "join_notice", project.id, larry.id, 'nice desert party bro!'
      ]
      drain_background_jobs!
