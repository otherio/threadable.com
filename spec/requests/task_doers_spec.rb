...
describe "Task doers", :type => :request do
  ...
  #   let(:tom)    { organization.members.find_by_user_slug! 'tom-canver'   } # is a doer
  #   let(:bob)    { organization.members.find_by_user_slug! 'bob-cauchois' } # is not a doer
  ...
  #       expect(response).to redirect_to my_conversation_url('raceteam', 'layup-body-carbon')
