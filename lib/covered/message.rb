class Covered::Message < ActiveRecord::Base

  belongs_to :conversation, counter_cache: true
  belongs_to :parent_message, class_name: 'Message', foreign_key: 'parent_id'
  belongs_to :user, :class_name => 'Covered::User' # <-- deprecated
  belongs_to :creator, class_name: 'Covered::User', foreign_key: 'user_id'
  has_one :project, through: :conversation
  has_and_belongs_to_many :attachments, class_name: 'Covered::Attachment'
