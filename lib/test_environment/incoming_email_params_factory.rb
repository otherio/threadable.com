class TestEnvironment::IncomingEmailParamsFactory < MethodObject
  ...
  def call
    ...
    params = {
      ...
      'attachment-count' => '3',
      'attachment-1'     => TestEnvironment.uploaded_file("some.gif", 'image/gif',  true),
      'attachment-2'     => TestEnvironment.uploaded_file("some.jpg", 'image/jpeg', true),
      'attachment-3'     => TestEnvironment.uploaded_file("some.txt", 'text/plain', false),
    }
